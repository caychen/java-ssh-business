...
<body>
	<form name="icform" method="post">
		...
		<div class="textbox-title">
			<img src="${ctx }/skin/default/images/icon/currency_yen.png" /> 修改货物
		</div>
		...
		<div>
			<table class="commonTable" cellspacing="1">
				<tr>
					...
					<td class="tableContent">
						<s:select name="factory.id"	list="factoryList"
							...
							listKey="id" listValue="factoryName" headerKey="" headerValue="--请选择--" />
				...
				<tr>
					...
					<td class="tableContent">
						<input type="text" name="productImage" value="${productImage }" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tableContent">
						<input type="text" name="loadingRate" value="${loadingRate }" />
					</td>
					<td class="columnTitle">箱数：</td>
					<td class="tableContent">
						<input type="text" name="boxNum" value="${boxNum }" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tableContent">
						<textarea name="productDesc" style="height: 150px;">${productDesc }</textarea>
					</td>
					<td class="columnTitle">要求：</td>
					<td class="tableContent">
						<textarea name="productRequest" style="height: 150px;">${productRequest }</textarea>
					</td>
				</tr>
			</table>
		</div>
