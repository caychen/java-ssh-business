		...
		<div class="modelDiv">
			<table class="modelTable" cellspacing="1">
				...
				<tr>
					...
					<td class="model_intro_right">横向模块权限控制(菜单、按钮、状态、功能点),
				...
				<tr>
					...
					<td class="model_intro_right">对人员角色进行权限分配, 实现用户权限批量设置,
						支持细粒度权限控制分配(菜单、按钮、状态、功能点)。</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="model_intro_right" width="81%">可对系统操作用户进行维护管理,
