...
<script language="javascript">
	...
	function toModule(moduleName) {
		//top是js提供的一个对象，代表顶层框架
		top.leftFrame.location.href = 'homeAction_toleft.action?moduleName='
				+ moduleName;
		top.main.location.href = 'homeAction_tomain.action?moduleName='
				+ moduleName;
...
<body onSelectStart="return true">
	...
	<div class="headerBg">
		<div class="top_logo">
			<div class="navMenu" style="float: left; text-align: left;">
				...
				<div style="height: 29px;">
					<span id="leftKey" onmouseover="periodOffset(this, 'left')">
						<img src="${ctx}/skin/default/images/title/left_arrow.png" />
					</span>
					...
					<div id="mask">
						<div id="menuContent">
							...
							<shiro:hasPermission name="统计分析">
								<span id="topmenu" onclick="toModule('stat');">统计分析</span>
								<span id="tm_separator"></span>
							</shiro:hasPermission>
						...
						<span id="rightKey" onmouseover="periodOffset(this, 'right')">
							<img src="${ctx}/skin/default/images/title/right_arrow.png" />
						</span>
					</div>
				</div>
			</div>
		...
		<div id="prompt_div">
			<img src="${ctx}/skin/default/images/title/prompt.png" />
			<span style="position: absolute; top: 2px; left: 35px; z-index: 99999; width: 100%; color: #FFFFFF; text-align: left;">
				鼠标指向箭头位置<br />可显示更多菜单项
			</span>
		</div>
