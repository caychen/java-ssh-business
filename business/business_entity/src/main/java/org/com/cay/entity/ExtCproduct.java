...
public class ExtCproduct extends BaseEntity {
	...
	public String toString() {
		return "ExtCproduct [contractProduct=" + contractProduct + ", factory=" + factory + ", id=" + id
				+ ", factoryName=" + factoryName + ", productNo=" + productNo + ", productImage=" + productImage
				+ ", productDesc=" + productDesc + ", packingUnit=" + packingUnit + ", cnumber=" + cnumber + ", price="
				+ price + ", amount=" + amount + ", productRequest=" + productRequest + ", orderNo=" + orderNo + "]";
	}
