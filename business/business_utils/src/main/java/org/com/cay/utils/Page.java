...
public class Page<T> {
	...
	public String getLinks() {
		...
		sBuf.append("<a href=\"#").append("\" onclick=\"setPageNo(").append(curPageNo).append(");formSubmit('")
		...
		sBuf.append("<a href=\"#").append("\" onclick=\"setPageNo(").append(this.totalPage).append(");formSubmit('")
				.append(url).append("','_self')");
		sBuf.append("\">[末页]");
		sBuf.append("</a>&nbsp;");
